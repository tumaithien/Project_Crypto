  ...
  return (
    <>
      <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative">
        ...
        <div className="mt-9 border border-gray-100 rounded min-h-[60vh]">
          {savedData ? (
            <table className="w-full table-auto">
              <thead className="capitalize text-base text-gray-100 font-medium border-b border-gray-100">
                <tr>
                  ...
                  <th className="py-1 sm:table-cell hidden">price</th>
                    ...
                    return (
                      ...
                      >
                        <td className="py-4 flex items-center uppercase">
                          ...
                          />
                          <span
                            onClick={() => getCoinDetails(item.id)}
            ...
            <div className="text-cyan text-lg font-semibold w-full min-h-[60vh] flex justify-center items-center">
