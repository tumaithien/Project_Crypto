...
const HightLowIndicator = ({ currentPrice, high, low }) => {
          ...
          <div className="flex items-center justify-between h-full w-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2">
              ...
              <div className="flex w-full flex-col mt-6">
                <div className="flex justify-between">
                  ...
                  <div
                    className={`text-sm ml-2 px-1 font-medium flex items-center rounded uppercase bg-opacity-25
                    ${
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  <a
                    ...
                    rel="noreferrer"
                    className="block p-1 bg-gray-200 text-gray-100 rounded my-1 text-sm"
                  >
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div
                    className={`text-sm ml-2 my-1 px-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-green text-green`}
                  >
                    <span>
                  ...
                  <div
                    className={`text-sm ml-2 my-1 px-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-red text-red`}
                  >
                    <span>
            ...
            <div className="flex flex-col w-[55%] h-full pl-3">
              ...
              <div className="flex mt-4 flex-col">
                <h3 className="text-base text-white capitalize py-1">
                  <span className="text-gray-100">market cap rank: </span>{" "}
                  {data?.market_cap_rank}{" "}
                </h3>
                <h3 className="text-base text-white capitalize py-1">
                  <span className="text-gray-100">coingecko rank: </span>{" "}
                  {data?.coingecko_rank}{" "}
                </h3>
                <h3 className="text-base text-white capitalize py-1">
                  <span className="text-gray-100">coingecko score: </span>{" "}
                  {data?.coingecko_score}{" "}
                </h3>
              </div>
            </div>
            <div className="absolute right-8 bottom-8 items-center flex">
